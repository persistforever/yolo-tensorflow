...
def main(method='train', gpus=''):
    ...
    option['image_x_size'] = 576
    option['image_y_size'] = 832
    option['n_channel'] = 10
    option['cell_x_size'] = 1
    option['cell_y_size'] = 13
    option['conv_x_size'] = 5
    option['conv_y_size'] = 5
    option['pool_mode'] = 'max'
    option['n_boxes'] = 1
    option['n_processes'] = 3
    option['max_objects'] = 5
    ...
    option['noobject_scale'] = 5
    option['object_scale'] = 5
    option['coord_scale'] = 10
    ...
    option['seq'] = 'table-v26'
    option['model'] = 'model_best.ckpt'
    option['update_function'] = 'adam'
